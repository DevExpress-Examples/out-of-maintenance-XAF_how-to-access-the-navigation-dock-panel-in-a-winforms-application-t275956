    ...
    Public Class HideNavigationPanelButtonsController
        ...
        Private Sub Form_Load(ByVal sender As Object, ByVal e As EventArgs)
            If TypeOf Frame.Template Is DevExpress.ExpressApp.Win.Templates.INavigationPanelHolder Then
                Dim navigationPanel As DevExpress.XtraBars.Docking.DockPanel = DirectCast(Frame.Template, DevExpress.ExpressApp.Win.Templates.INavigationPanelHolder).DockPanelNavigation
